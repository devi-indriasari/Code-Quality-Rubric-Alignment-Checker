...
if st.session_state.get("has_prediction_result") and st.session_state.get("last_result_df") is not None:
    ...
    st.caption(
        ...
        "dan tetap perlu divalidasi oleh manusia. Jika model yang digunakan adalah LinearSVC, persentase dihitung dari decision score "
        "yang dinormalisasi sehingga menunjukkan keyakinan relatif model, bukan probabilitas statistik yang terkalibrasi. "
